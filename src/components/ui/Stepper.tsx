...
export const Stepper = forwardRef<StepperRef, StepperProps>(function Stepper(
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-md border border-neutral-200 rounded-4xl shadow-xl ${stepCircleContainerClassName}`}
      >
        <div
    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: "#ea580c", color: "#5227FF" },
          complete: { scale: 1, backgroundColor: "#ea580c", color: "#3b82f6" },
        }}
